...
public class Bibliothèque {
	...
	public static void main(String[] args) {
		...
		//On instancie un LecteurDAO pour avoir accès à nos méthodes d'accès aux données
		...
		do {					
			...
			if(lecteur == null) {
				do {
					System.out.println("Se Logger (L)");
					System.out.println("Créer un compte (C)");
					...
					case "C":
						...
						System.out.println("Quelle est votre login?");
						String login = scan.nextLine();
						System.out.println("Quelle est votre password?");
						String password = scan.nextLine();
						boolean cree = dao.creerCompte(nom, prenom, adresse, login, password);
						if(!cree) {
							System.out.println("Ce login n'est pas diponible; choisissez en un autre");
						}
						break;
					case "L":
						System.out.println("Quel est votre login ?");
						String loginLecteur = scan.nextLine();
						System.out.println("Quel est votre password");
						String passwordUtilisateur = scan.nextLine();
						lecteur = dao.seConnecter(loginLecteur, passwordUtilisateur);
						if(lecteur != null) {
							System.out.println("Heureux de vous revoir " + lecteur.getPrenom()
							+ " " + lecteur.getNom() + "!!!");
